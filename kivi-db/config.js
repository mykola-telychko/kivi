const NAMES = [
  ...
  'Alexander', 'Zimmermann', 'Kathrin', 'Braun',
  'Daniel', 'Krüger', 'Melanie', 'Hofmann',
  'Jürgen', 'Schmitt', 'Barbara', 'Werner',
  'Tobias', 'Lange', 'Anja', 'Schmid', 'Nico', 'Krause', 'Tanja', 'Vogel', 'Oliver', 'Stein', 'Janine', 'Otto', 'Max', 'Günther',
  'Jasmin', 'Berger', 'Sven', 'Arnold', 'Laura', 'Peters', 'Florian', 'Huber', 'Nina', 'Walter',
